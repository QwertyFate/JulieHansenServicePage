    ...
    return(
        <div className="grid grid-cols-1 lg:grid-cols-2 mt-20 w-10/12 min-[1281px]:w-9/12 mx-auto">
            <div className="flex flex-col font-Lora justify-center">
                ...
                <div className="hidden flex-row mt-16 items-center lg:flex">
            ...
            <div className="flex flex-col font-Lora justify-center max-lg:mt-10 lg:ml-40">
                <h1 className="text-3xl font-semibold">Newsletter</h1>
                <p className="text-black text-xl  mt-8 text-justify lg:10/12 min-[1281px]::w-8/12">Subscribe to our Newsletter for latest news and updates. Stay tuned! </p>
                <form className="min-[1281px]::w-9/12">
                ...
                <div className="flex flex-row mt-16 items-center lg:hidden">
                    <a href="/"><img src="images/facebooksvg.svg" alt="facebooklogo" height={40} width={40} className="mx-2 hover:opacity-70"/></a>
                    <a href="/"><img src="images/linkedinsvg.svg" alt="linkedinlogo" height={35} width={35} className="mx-2 hover:opacity-70"/></a>
                </div>
            </div>
            ...
            <h2 className="mt-10 mb-20 text-xl font-medium lg:ml-40">Copyright 2024 | Privacy Policy</h2>
        </div>
    )
}
