...
const AboutSection = () => {
    return(
        <div className="flex flex-col mt-20 w-10/12 mx-auto justify-center items-center">
            <div className="grid grid-cols-2">
                <div className="flex flex-col font-Lora justify-center mr-20">
                ...
                <img src="https://res.cloudinary.com/luxuryp/images/f_auto,q_auto/azjfmtzx6evxpubynfci/edit-page-11r2"/>
                <img src="https://res.cloudinary.com/luxuryp/images/f_auto,q_auto/m5ea1kpipv5tiflnfx8t/edited-p-12"/>
                <div className="flex flex-col font-Lora justify-center w-11/12 ml-10">
                    <h1 className="text-3xl font-semibold text-center">We Want To Create An Unforgettable Experience For You</h1>
