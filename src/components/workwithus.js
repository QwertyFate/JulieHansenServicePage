    ...
    return(        
        <div className="relative h-[700px] w-full">
            ...
            <div className="relative w-5/6 flex mx-auto font-Lora flex-col items-center text-white ">
                <h1 className="pt-56 text-5xl font-light ">Work With Us</h1>
                <div className="w-40 mt-10 border-b-[2px] border-white "></div>
                <p className="text-md mt-10 w-4/12 text-center tracking-widest">With decades of experience in luxurious Tri Valley real estate, our team is here to ensure that your dreams are a reality. Let us guide you through your home buying journey, contact us today!</p>
